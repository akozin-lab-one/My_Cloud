...
<div class="mt-12">
    <div>
        <div class="flex">
            ...
            <h2 class="text-3xl font-bold ml-7 mr-7"><a href="{{route('user#folderPage',$foldername)}}">{{ $foldername }}</a></h2>
            <span class="mt-2 font-bold">></span>
            <h2 class="text-3xl font-bold ml-7">{{ $subfoldername }}</h2>
        </div>
                    ...
                    <div
                        ...
                        <div class="flex shadow-sm justify-between">
                            <div class="flex ml-5 py-3">
                                ...
                                <a href="{{ route('user#doublePage', [$da->name]) }}">
